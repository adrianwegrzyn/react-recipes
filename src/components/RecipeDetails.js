...
class RecipeDetails extends Component {
    ...
    //     this.state = {
    //         recipe:recipe,
    //         url: `https://www.food2fork.com/api/get?key=d85bb237a2cbc43061da66201845cb58&q&rId=${this.props.id}`
    //     }
    // }
    ...
    async componentDidMount() {
        ...
        const url = `https://www.food2fork.com/api/get?key=d85bb237a2cbc43061da66201845cb58&q&rId=${id}`;
    //     try {
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-10 mx-auto col-md-6 my-3">
                            ...
                            <h6 className="text-warning text-capitalize textSlanted">provided by {publisher}</h6>
                            ...
                            <ul className="list-group mt-4">
                                <h2 className="mt-3 mb-4">Ingredients</h2>
                                {
                                    ingredients.map((item, index) => {
                                        return (
                                            <li key={index} className="list-group-item textSlanted">
                                                {item}
                                            </li>
                                        )
                                    })
